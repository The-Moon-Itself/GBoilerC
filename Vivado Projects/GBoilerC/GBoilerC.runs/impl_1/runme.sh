...
HD_PWD='C:/GitRepos/GBoilerC/Vivado Projects/GBoilerC/GBoilerC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GBC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GBC.tcl -notrace
