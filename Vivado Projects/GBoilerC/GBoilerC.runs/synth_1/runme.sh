...
HD_PWD='C:/GitRepos/GBoilerC/Vivado Projects/GBoilerC/GBoilerC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GBC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GBC.tcl
